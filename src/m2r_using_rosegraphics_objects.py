...
#             objects have: circle, center, raidus
#
#
#     f. What does a RoseWindow RENDER method do?
#           It pauses the code for a speciifed amount of seconds
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            At the end of the code so the window will reamain open
#            until the user so choses to close it.
#
